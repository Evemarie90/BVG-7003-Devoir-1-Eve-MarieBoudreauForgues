...
# Plot expression levels by sex (As theme is set to minimal, you can personnalize theme and add colors and legend. If you want to vizualise your graph you can copy the script for the graph in the Console and run it, it will appear in the right pannel lable 'plots' and then you can export your graph). 
